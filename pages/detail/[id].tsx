  ...
  return (
    ...
    flex-wrap lg:flex-nowrap'>
       ...
       justify-center items-center bg-black'>
        <div className='absolute top-6 left-2 lg:left-6 flex gap-6
        z-50'>
        ...
        lg:right-10 cursor-pointer'>
            ...
            >
                <HiVolumeOff  className='text-white
            ...
            >
                <HiVolumeUp className='text-white 
                text-2xl lg:text-4xl' />
            </button>
        )}
        </div>
            ...
            <div>
                <Link href="/">
                    <div className='flex flex-col gap-2 mt-3'>
                        <p className='flex gap-2 md:text-md
