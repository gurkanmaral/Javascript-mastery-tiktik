...
const Upload = () => {
  ...
  return (
    ...
    pt-10 lg:pt-20 bg-[#F8F8F8] justify-center'>
        <div className='bg-white rounded-lg xl:h-[80vh] flex gap-6 w-[65%]
        flex-wrap justify-between items-center p-14 pt-6'>
            <div>
                <div>
            ...
            <div className='flex flex-col gap-3 pb-10'>
                        ...
                        className="rounded outline-none text-md border-2
                        border-gray-200 p-2"
                        />
